...
def tokenize_instructions_qwen_chat(
    ...
    if instruct == 'qa':
        qa_prompts = [qa_instruct + '\n```\n\n# Query:\n```\n' + instruction + '\n```\n\n# Answer:\n```\n' for instruction in instructions]
        prompts = [QWEN_CHAT_TEMPLATE.format(instruction=qa_prompt) for qa_prompt in qa_prompts]
    elif instruct == 'urial':
        urial_prompts = [urial_instruct + '\n```\n\n# Query:\n```\n' + instruction + '\n```\n\n# Answer:\n```\n' for instruction in instructions]
        prompts = [QWEN_CHAT_TEMPLATE.format(instruction=urial_prompt) for urial_prompt in urial_prompts]
    elif instruct == 'base':
