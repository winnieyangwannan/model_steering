...
def parse_args():
    ...
    parser.add_argument('--layer', default=15, type=int)
    parser.add_argument('--strength', default=10.0, type=float)
    parser.add_argument('--save_path', default= '/gpfs/data/buzsakilab/wy547/Code/model_steering/prompt_activation_steering', type=str)
    parser.add_argument('--hf_token', default= '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', type=str)
