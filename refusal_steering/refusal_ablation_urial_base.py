...
for cur_id in tqdm(range(0, N_INST_TRAIN, batch_size)):
    ...
    # for layer in range(model.cfg.n_layers):
        # harmless_cache_all[cur_id:cur_id + batch_size,:] = harmless_cache[ f'blocks.{layer}.hook_resid_pre'][:, pos, :]
        # harmless_cache_all_qa[layer,cur_id:cur_id + args.batch_size,:] = harmless_cache_qa['resid_pre', layer][:, args.pos, :]
        # harmless_cache_all_urial[cur_id:cur_id + batch_size,:] = harmless_cache_urial[ f'blocks.{layer}.hook_resid_pre'][:, args.pos, :]
